...
import cc.ranmc.server.network.PluginHandler;
...
import static cc.ranmc.server.constant.Data.PLUGIN_PATH;
...
public final class Main {
    ...
    static void main() {
        ...
        props.put("mail.smtp.host", "gz-smtp.qcloudmail.com");
        ...
        Javalin.create(config -> {
            ...
            config.routes.get(PLUGIN_PATH, PluginHandler::handle);
